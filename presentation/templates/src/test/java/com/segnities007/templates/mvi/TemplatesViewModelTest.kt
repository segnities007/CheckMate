...
class TemplatesViewModelTest {
    ...
    @Test
    fun `Given 初期状態 When ShowBottomSheet Then isShowingBottomSheetがtrueになる`() = runTest(testDispatcher) {
        // Given
    ...
    @Test
    fun `Given BottomSheet表示中 When HideBottomSheet Then isShowingBottomSheetがfalseになる`() = runTest(testDispatcher) {
        // Given
        viewModel = TemplatesViewModel(
            getAllWeeklyTemplatesUseCase,
            addWeeklyTemplateUseCase,
    ...
    @Test
    fun `Given 初期状態 When NavigateToWeeklyTemplateList Then currentRouteが更新される`() = runTest(testDispatcher) {
        // Given
        viewModel = TemplatesViewModel(
            getAllWeeklyTemplatesUseCase,
            addWeeklyTemplateUseCase,
        ...
        assertEquals(NavKey.WeeklyTemplateList, viewModel.uiState.value.data.currentRoute)
        ...
        // Then
        val state = viewModel.uiState.value
        assertEquals(NavKey.WeeklyTemplateList, state.data.currentRoute)
    }

    @Test
    fun `Given 初期状態 When NavigateToWeeklyTemplateSelector Then currentRouteが更新される`() = runTest(testDispatcher) {
        // Given
        viewModel = TemplatesViewModel(
            getAllWeeklyTemplatesUseCase,
            addWeeklyTemplateUseCase,
        ...
        // Then
        val state = viewModel.uiState.value
        assertEquals(NavKey.WeeklyTemplateSelector, state.data.currentRoute)
    }

    @Test
    fun `Given 初期状態 When UpdateTemplateSearchQuery Then searchQueryが更新される`() = runTest(testDispatcher) {
        // Given
        viewModel = TemplatesViewModel(
            getAllWeeklyTemplatesUseCase,
            addWeeklyTemplateUseCase,
